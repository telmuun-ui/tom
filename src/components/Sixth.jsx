...
export const Sixth = () => {
  ...
  return (
    <section className=" py-20">
      <div className="flex flex-row-reverse rounded-xl shadow-md bg-gray-50 max-w-6xl mx-auto  h-120">
        <div className="flex justify-center items-center w-143 h-120">
          <div className="flex justify-center items-center  w-120 h-96 ">
            <img src="./zurag2.png" alt="" className="rounded-xl" />
          </div>
        </div>
        <div className="bg-white w-145 h-120 rounded-l-lg">
          <div className="flex text-xl pt-12 pl-12 font-semibold">
            Mentorhub
          </div>
